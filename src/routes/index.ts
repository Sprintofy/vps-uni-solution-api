...
import tradeProofsRoute from "./tradeProofs.route";
import stockRoute from "./stock.route";
import postTradeOrder from "./postTrade.route";
...
router.use('/trade-proofs',tradeProofsRoute);
router.use('/stocks',stockRoute);
router.use('/post-trade',postTradeOrder);
