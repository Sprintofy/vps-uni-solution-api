...
router.post('/fetch-all-logs',celebrate(clientTradeSchema.fetch_all_logs_by_clients),clientTradeController.fetch_all_clients_trades_logs);

router.get('/trade-details',celebrate(clientTradeSchema.fetch_trades_details_by_client_id),clientTradeController.fetch_trades_details_by_client_id);
